...
# 1. Ingestion
sales_df = pd.read_csv(r"C:\Users\PROMODH\Downloads\FDE lab\Lab-2\Lab-2\raw_data\sale_price.csv")
feedback_df = pd.read_json(r"C:\Users\PROMODH\Downloads\FDE lab\Lab-2\Lab-2\raw_data\customer_feedback.json")
